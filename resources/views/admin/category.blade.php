...
<div class="page-title">
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Kategori</h3>
            <p class="text-subtitle text-muted">Halaman untuk menambah, mengedit, dan menghapus kategori</a>.</p>
        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="kategoriInput">Nama Kategori</label>
                                    <input type="text" id="kategoriInput" class="form-control @error('kategori','tambah') is-invalid @enderror" name="kategori" placeholder="Masukkan nama kategori" value="{{ old('kategori') }}">
                                    @error('kategori','tambah')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="kategoriInput" class="form-control @error('kategori','edit') is-invalid @enderror" name="kategori" placeholder="Masukkan nama kategori" value="{{ old('kategori') }}">
                                    @error('kategori','edit')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
